...
Daily records may store numeric per-message score history in `message_scores`.
This history contains event ids, timestamps, and metric scores only; it must not
include raw text, redacted text, summaries, quotes, or evidence.
...
The 2026-07-16 changes were deployed to the production `safe-mind-api` Lambda
with image digest
`sha256:242de3f2a8e9a63068ad06be55eb80954f14d82798adf8be2486c5c74f127e65`.
Post-deploy public health checks passed.
